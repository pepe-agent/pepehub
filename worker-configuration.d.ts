/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cec8020925ab26ead48d72e7e845b00f)
// Runtime types generated with workerd@1.20260804.1 2026-08-01 nodejs_compat
interface __BaseEnv_Env {
	ARTIFACTS: R2Bucket;
	DB: D1Database;
	RATE_LIMIT_READ_ANON: RateLimit;
	RATE_LIMIT_READ_AUTH: RateLimit;
	RATE_LIMIT_WRITE_ANON: RateLimit;
	RATE_LIMIT_WRITE_AUTH: RateLimit;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_OAUTH_CLIENT_ID" | "GITHUB_OAUTH_CLIENT_SECRET" | "SESSION_SECRET">> {}
}
